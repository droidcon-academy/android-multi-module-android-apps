...
import com.droidcon.droidynote.shared.ui.components.NoteItemView
import kotlinx.serialization.Serializable

@Serializable
object NoteListRoute

fun NavGraphBuilder.noteListScreen(onNavigateToDetail: (Int?) -> Unit) {
    composable<NoteListRoute> {
        NoteListScreen(onNavigateToDetail = onNavigateToDetail)
    }
}
...
@Composable
private fun EmptyNoteListScreenContent(modifier: Modifier = Modifier) {
    Box(
